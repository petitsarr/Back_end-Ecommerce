let mongoose,categorySchema;_b16‍.x([["addCategory",()=>addCategory],["deleteCategory",()=>deleteCategory],["getAllCategory",()=>getAllCategory],["getCategoryById",()=>getCategoryById],["updateCategoryById",()=>updateCategoryById]]);_b16‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_b16‍.w("../models/category",[["default",["categorySchema"],function(v){categorySchema=v}]]);
...
const addCategory = async (req ,res) => { 
    try {  
        ...
        let category = new Category ({
            ...
            _b16‍.g.console.log("Mes nouveaux category à ajoute sont ==>" , category) ;
            await category.save() 
       if(category) {

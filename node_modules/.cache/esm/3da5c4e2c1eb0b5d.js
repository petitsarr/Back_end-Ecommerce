let mongoose,categorySchema;_c1e‍.x([["addCategory",()=>addCategory],["deleteCategory",()=>deleteCategory],["getAllCategory",()=>getAllCategory],["getCategoryById",()=>getCategoryById],["updateCategoryById",()=>updateCategoryById]]);_c1e‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_c1e‍.w("../models/category",[["default",["categorySchema"],function(v){categorySchema=v}]]);
...
const addCategory = async (req ,res) => { 
    try {  
        ...
        let category = new Category ({
            ...
            _c1e‍.g.console.log("Mes nouveaux category à ajoute sont ==>" , category) ;
            await category.save() 
       if(category) {

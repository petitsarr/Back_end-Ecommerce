let mongoose,userSchema,bcrypt,jwt,dotenv;_bdc‍.x([["UserInscription",()=>UserInscription],["deleteUserById",()=>deleteUserById],["getUserCount",()=>getUserCount],["UserConnection",()=>UserConnection],["getUser",()=>getUser],["getUserById",()=>getUserById]]);_bdc‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_bdc‍.w("../models/user",[["default",["userSchema"],function(v){userSchema=v}]]);_bdc‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_bdc‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_bdc‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);
...
const UserInscription = async (req ,res) => {
    try {  
        ...
        _bdc‍.g.console.log("Mes datas sont ==>" ,
        name  ,
        email ,
        passwordHash  ,
        phone  ,

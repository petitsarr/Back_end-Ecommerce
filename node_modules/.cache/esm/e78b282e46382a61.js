let mongoose,userSchema,bcrypt,jwt,dotenv;_463‍.x([["UserInscription",()=>UserInscription],["deleteUserById",()=>deleteUserById],["getUserCount",()=>getUserCount],["UserConnection",()=>UserConnection],["getUser",()=>getUser],["getUserById",()=>getUserById]]);_463‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_463‍.w("../models/user",[["default",["userSchema"],function(v){userSchema=v}]]);_463‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_463‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_463‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);
...
const UserInscription = async (req ,res) => {
    try {  
        ...
        _463‍.g.console.log("Mes datas sont ==>" ,
        name  ,
        email ,
        passwordHash  ,
        phone  ,

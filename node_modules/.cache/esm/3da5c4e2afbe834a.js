let mongoose,categorySchema;_afb‍.x([["addCategory",()=>addCategory],["deleteCategory",()=>deleteCategory],["getAllCategory",()=>getAllCategory],["getCategoryById",()=>getCategoryById],["updateCategoryById",()=>updateCategoryById]]);_afb‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_afb‍.w("../models/category",[["default",["categorySchema"],function(v){categorySchema=v}]]);
...
const addCategory = async (req ,res) => { 
    try {  
        ...
        let category = new Category ({
            ...
            _afb‍.g.console.log("Mes nouveaux category à ajoute sont ==>" , category) ;
            await category.save() 
       if(category) {

let mongoose,categorySchema;_5bf‍.x([["addCategory",()=>addCategory],["deleteCategory",()=>deleteCategory],["getAllCategory",()=>getAllCategory],["getCategoryById",()=>getCategoryById],["updateCategoryById",()=>updateCategoryById]]);_5bf‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_5bf‍.w("../models/category",[["default",["categorySchema"],function(v){categorySchema=v}]]);
...
const addCategory = async (req ,res) => { 
    try {  
        ...
        let category = new Category ({
            ...
            _5bf‍.g.console.log("Mes nouveaux category à ajoute sont ==>" , category) ;
            await category.save() 
       if(category) {
